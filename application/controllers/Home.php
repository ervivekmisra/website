...
class Home extends CI_Controller 
{
    ...
    {
        $friend_requests = $this->user_model->get_friend_requests($this->user->info->ID);

        //        $this->user->info->noti_count_friend = $friend_requests->num_rows();
//        $this->user_model->update_field($this->user->info->ID, "noti_count_friend", $friend_requests->num_rows());

        $this->template->loadAjax("home/ajax_friend_requests.php", array(
