...
#---------------------------------    
    public function __construct() {
        ...
        $this->load->model("Newssettings",'nsettings');
        $this->load->model("Page","page");
        $this->load->model('Pb_function', 'pb');
        $this->load->model('News_Page_model', 'ps');
    ...
    public function index() {
     ...
     #---------------------
        ...
        //Getting SEO Properties
            $data['seo']['analytics_code'] = $this->nsettings->get_previous_settings('settings', 5);
            $data['seo']['alexa_code'] = $this->nsettings->get_previous_settings('settings', 11);
            $data['social_link'] = $this->nsettings->get_previous_settings('settings', 111);
       //Page view settings
            $data['ads'] = $this->ads->SelectAds();
            $data['main_menu'] = $this->nsettings->main_menu();
            $data['menus'] = $this->nsettings->menu_position_3();
            $data['footer_menu'] = $this->nsettings->footer_menu();
            ...
            $this->template->loadContent('themes/' . $default_theme . '/Page',$data);
        ...
        //Getting SEO Properties
            $data['seo']['analytics_code'] = $this->nsettings->get_previous_settings('settings', 5);
            $data['seo']['alexa_code'] = $this->nsettings->get_previous_settings('settings', 11);
            $data['seo']['social_sites'] = $this->nsettings->get_previous_settings('settings', 6);
            $data['seo']['fixed_keyword'] = $this->nsettings->get_previous_settings('settings', 10);
            $data['social_link'] = $this->nsettings->get_previous_settings('settings', 111);
        //Page view settings
            $data['ads'] = $this->ads->SelectAds();
            $data['main_menu'] = $this->nsettings->main_menu();
           ...
           // $this->output->cache(30);*/
            $this->template->set_layout("client/themes/newstitan",$data);
            $this->template->loadContent('themes/' . $default_theme . '/page_view',$data);
        }
    }
...
#--------------------------------- 
    public function get_pagination_config($category_slug) {
        ...
        $config['per_page'] = 8;
        $config['base_url'] = base_url() .'c/'.$category_slug . '/page';
...
#--------------------------------- 
    public function page() {
        ...
        $m_data['social_link'] = $this->nsettings->get_previous_settings('settings', 111);
        $m_data['ads'] = $this->ads->SelectAds();
        $m_data['main_menu'] = $this->nsettings->main_menu();
        $m_data['menus'] = $this->nsettings->menu_position_3();
        $m_data['footer_menu'] = $this->nsettings->footer_menu();
        ...
        $this->template->set_layout("client/themes/newstitan",$m_data);
        $this->template->loadContent('themes/' . $default_theme . '/page_view',$m_data);
