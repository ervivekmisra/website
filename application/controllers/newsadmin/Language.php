...
public function phrase()
{
    ...
    $data['title']     = "Phrase List"; 
        ...
        #pagination starts
        #
    $config["base_url"]       = base_url('newsadmin/language/phrase/'); 
    ...
    if (sizeof($lang) > 0) {
        ...
        if ($this->db->table_exists($this->table)) {
            ...
            if ($this->db->field_exists($this->phrase, $this->table)) {
                ...
                redirect('newsadmin/language/phrase');
            }  
        ...
        if ($this->db->table_exists($this->table)) {
            ...
            if ($this->db->field_exists($language, $this->table)) {
                ...
                if (sizeof($phrase) > 0)
                    ...
                    redirect('newsadmin/language/editPhrase/'.$language);
