...
#-----------------------------------------
    public function __construct() {
        ...
        $this->load->model('admin/Archive_model','archive_model');
...
#------------------------------------------------
    public function maximum_archive_settings_view() {
        ...
        $this->load->view('admin/settings/max_archive_settings');
...
#-----------------------------------------------
    public function save_max_archive_settings() {
        ...
        redirect('newsadmin/Archive/maximum_archive_settings_view');
    }
#------------------------------------------
...
#----------------------------------------
    public function news_routing($tbl_name, $news_id) {
        $update_routing_table = $this->db->query("UPDATE news_routing SET table_name='$tbl_name' WHERE news_id='$news_id'");
    }
#----------------------------------------
...
#---------------------------------------
    public function delete_news_by_id($tbl_name, $news_id) {
        $query = $this->db->query("DELETE FROM $tbl_name WHERE news_id='$news_id'");
    }
#-----------------------------------------------
