...
class Common 
{
    ...
    public function get_url_details($v) 
    {
        ...
        $video_id = $this->getYouTubeVideoID($v);
        if($video_id == ""){
...
//        ));
            ...
            curl_setopt($curl,CURLOPT_USERAGENT, $User_Agent);// $_SERVER['HTTP_USER_AGENT']);
...
//            echo $html; exit;
            ...
            $api_key = 'AIzaSyBezgAYU79i3zzLxPevnF9GnwAD6sccXio';
...
//            $imgage = "https://img.youtube.com/vi/".$video_id."/0.jpg";
        }
