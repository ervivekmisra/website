...
<?php if($r->pollid > 0) : ?>
	<?php // Get answers
	$answers = $this->feed_model->get_poll_answers($r->pollid, $this->user->info->ID);
	?>
...
Total Votes: <?php echo number_format($r->poll_votes) ?>
</div>
<?php endif; ?>
</div>
<?php endif; ?>
...
<script type="text/javascript">
			...
			$('.feed-footer .editor-button').click(function() {
			      $(this).attr('disabled', 'disabled');
			      $(this).addClass('disablebutton');
			      setTimeout( function(){ 
			          $('.feed-footer .editor-button').removeAttr('disabled');
			          $('.feed-footer .editor-button').removeClass('disablebutton');
			      },4000 );
			  });
</script>
<?php endif; ?>