...
<?php endif; ?>
    ...
    <div class="user-sidebar-area">
        ...
        <div class="user-sidebar-icons">
          <a href="<?php echo site_url("user_settings") ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_156") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("profile/" . $this->user->info->username) ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_200") ?>"><span class="glyphicon glyphicon-user"></span></a>
          </div>
        <?php endif; ?>
    ...
    <div id="footer" class="clearfix">
      <span class="pull-left"><?php echo lang("ctn_170") ?> <a href="http://surfcloud.com.br">surfcloud</a> <?php echo $this->settings->info->site_name ?> V<?php echo $this->settings->version ?></span> <span class="pull-right"><a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></span>
    </div>
