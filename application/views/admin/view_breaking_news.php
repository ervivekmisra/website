...
<aside class="right-side">
    <section class="content">
        ...
        <?php 
            ...
            echo form_open('newsadmin/bcommon/breaking_save/', $attributes);
        ?>
        ...
        <?php 
            ...
            echo form_open('newsadmin/bcommon/breaking_delete_selected', $attributes);
        ?>
            <form name="f" method="post" action="<?php echo base_url(); ?>newsadmin/bcommon/breaking_delete_selected">
                ...
                <table class="table table-bordered">
                    ...
                    foreach ($query as $row) {
                        ...
                        <tr>
                            ...
                            <th width="50"><a  href="<?php echo base_url(); ?>newsadmin/bcommon/breaking_delete/<?php echo $row['id']; ?>"><i class="fa fa-2x fa-trash-o"></i></a></th>
                            <th width="30"><a title="Note: Click On for Slider start, Off for slider stop." href="<?php echo base_url(); ?>newsadmin/bcommon/breaking_status_edit/<?php echo $row['id'] . '/' . $row['status']; ?>"><?php echo ($row['status'] == 0) ? "On" : "Off";
                    ;
                        ?></a></th>
                        </tr>
                        <?php
