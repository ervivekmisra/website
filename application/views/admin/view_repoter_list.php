            ...
            ?>
                    <tr id="tr_<?php echo $sl; ?>" onclick="change_color('<?php echo $sl; ?>', '#<?php echo $bgcolor; ?>');">
                        ...
                        <td align="center">
                            ...
                            <a title="Note: Click To Post Approval Status Change." href="<?php echo base_url(); ?>newsadmin/Users/repoter_post_approval_status/<?php echo $row['id'] . '/' . $row['post_ap_status']; ?>">
                            ...
                            <?php } else{?>
                             <a  href="<?php echo base_url(); ?>newsadmin/Users/repoter_post_approval_status/<?php echo $row['id'] . '/' . $row['post_ap_status']; ?>">
                                <?php
                        ...
                        <th width="50">
                            <a href="<?php echo base_url(); ?>newsadmin/Users/repoter_edit/<?php echo $row['id']; ?>"><i class="fa fa-2x fa-edit"></i></a>
                            <a onclick="delete_cnf('<?php echo base_url(); ?>newsadmin/Users/repoter_delete/<?php echo $row['id']; ?>');" href="#"><i class="fa fa-2x fa-trash-o"></i></a>
                        </th>
                        ...
                        <th width="30"><a class="text-success"  href="<?php echo base_url(); ?>newsadmin/Users/repoter_status_edit/<?php echo $row['id'] . '/' . $row['status']; ?>"><?php
