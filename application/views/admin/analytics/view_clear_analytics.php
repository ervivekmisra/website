...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-md-3"> 
            <a  class="btn btn-warning btn-lg cache_modal" href="<?php echo base_url();?>newsadmin/User_analytics/delete">
        ...
        if(@$an->user_analytics=='active'){?>
            <a  class="btn btn-danger btn-lg cache_modal" href="<?php echo base_url();?>newsadmin/User_analytics/analytics_status/<?php echo @$an->user_analytics?>">
               
                  <?php echo display('disable_analytics');?>
            </a>
            <?php } else{?>
             <a  class="btn btn-success btn-lg cache_modal" href="<?php echo base_url();?>newsadmin/User_analytics/analytics_status/<?php echo @$an->user_analytics;?>">
