<script type="text/javascript">
    $(document).ready(function () {
        $('#delete_cache').click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url();?>newsadmin/Cache_controller/delete_cache",
...
<!--<div class="form-group">-->
                ...
                <div class="row">
                    <div class="col-md-3"> 
                     ...
                     <div class="col-md-3">   
                        <?php if($d->status==0){ ?>
                        <a href="<?php echo base_url();?>newsadmin/Cache_controller/ceche_on" class="btn btn-lg btn-success"><?php echo display('cache_on')?></a>
                        <?php } else { ?>
                            <a href="<?php echo base_url();?>newsadmin/Cache_controller/ceche_off" class="btn btn-lg btn-danger"><?php echo display('cache_off')?></a>
                        <?php } ?>
                     </div>  
                     <div class="col-md-3">
