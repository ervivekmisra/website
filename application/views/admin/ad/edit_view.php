            ...
            <div class="col-sm-5 col-sm-offset-3">
                <?php
                    $attributes = array('method'=>'post','class'=>'form-horizontal');
                       echo form_open_multipart('newsadmin/Ad/update/update/' . $ads->id, $attributes)
                ?>
                    ...
                    <div class="form-group">
                        <a href="<?php echo base_url(); ?>newsadmin/Ad/view_ads" class="btn btn-primary "><i class="glyphicon glyphicon-backward"></i> <?php echo display('back')?></a>                                            
