                ...
                ?>
                    <tr  id="tr_<?php echo $sl; ?>" onclick="change_color('<?php echo $sl; ?>', '#<?php echo $bgcolor; ?>');">
                        ...
                        <td align="center">
                            ...
                            if ($value->status == 0) {
                            ?>
                                <a class="label label-warning" title="Publish" href="<?php echo base_url(); ?>newsadmin/Page/publishd/<?php echo $value->page_id; ?>"><?php echo display('publish')?></a>

                            <?php
                            } else {
                            ?>
                                <a class="label label-success" title="Publishd" href="<?php echo base_url(); ?>newsadmin/Page/unpublishd/<?php echo $value->page_id; ?>"><?php echo display('unpublish')?></a>
                            <?php
                            }
                            ?>
                        </td>
                        <th width="40"><a href="<?php echo base_url(); ?>newsadmin/Page/Edit_page/<?php echo $value->page_id; ?>"><i class="fa fa-edit fa-2x"></i></a></th>
                        <th width="50"><a onclick="delete_cnf('<?php echo base_url(); ?>newsadmin/Page/Delete_page/<?php echo $value->page_id; ?>')" href="#"><i class="fa fa-trash-o fa-2x"></i></a></th>
                    </tr>
                    <?php
                    $sl++;
                }
