    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?= base_url('newsadmin/language/phrase') ?>"> <i class="fa fa-plus"></i> Add Phrase</a>
                    <a class="btn btn-primary" href="<?= base_url('newsadmin/language') ?>"> <i class="fa fa-list"></i>  Language List </a> 
                </div> 
            </div>
            <div class="panel-body">
                <div class="row">
                    <!-- phrase -->
                    <div class="col-sm-12">
                        <?= form_open('newsadmin/language/addlebel') ?>
