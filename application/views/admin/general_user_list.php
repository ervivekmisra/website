        ...
        <fieldset><legend><?php echo display('user_list')?></legend>   
            ...
            ?>
                    <tr>
                        ...
                        <td>
                           <a href="<?php echo base_url()?>newsadmin/General_user/delete_user/<?php echo $row['id'];?>"><span class="label label-danger" ><i class="fa fa-trash-o"></i><span class="label label-danger" ></a>
                        </td>
