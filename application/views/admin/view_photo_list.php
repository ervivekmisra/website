...
<aside class="right-side">
    ...
    <div class="row">                                    
        ...
        @$attt = array('method' => 'get' );
         echo form_open('newsadmin/Photo_list',$attt);?>
        ...
        <table border="1" rules="all" width="99%" class="table">
            ...
            foreach ($query as $row) {
                ...
                <tr>
                    ...
                    <?php if ($user_type == 3) { ?>
                        <th width="50"><?php echo anchor_popup('newsadmin/Photo_upload/MyWindow/' . $row['id'], '<i class="fa fa-edit fa-2x"></li>', $atts); ?></th>
                        ...
                        <th width="50"><a title="Note: Click On for Slider start, Off for slider stop." href="<?php echo base_url(); ?>newsadmin/Photo_upload/status_edit/<?php echo $row['id'] . '/' . $row['status']; ?>"><?php
