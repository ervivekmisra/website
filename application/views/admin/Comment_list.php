            ...
            ?>
                    <tr>
                        ...
                        <span class="label label-info" ><i class="fa fa-eye" aria-hidden="true"></i></span>
                         ...
                         <?php  if($row->com_status==1){;?>
                         <a href="<?php echo base_url()?>newsadmin/Comments_manage/un_varifid/<?php echo $row->com_id;?>">
                        <span class="label label-success" > <i class="fa fa-check" aria-hidden="true"></i></span>
                        </a>
                        <?php  }else{?>
                        <a href="<?php echo base_url()?>newsadmin/Comments_manage/varifid/<?php echo $row->com_id;?>">
                        <span class="label label-danger" ><i class="fa fa-times" aria-hidden="true"></i></span>
                        </a>
                        <?php  }?>
                           
                             <a href="<?php echo base_url()?>newsadmin/Comments_manage/delete_comments/<?php echo $row->com_id;?>"><span class="label label-danger" ><i class="fa fa-trash-o"></i><span class="label label-danger" ></a>
                        </td>
...
<script type="text/javascript">
    function viewInfo(id) {
        ...
        var url = "<?php echo site_url('newsadmin/Comments_manage/get_com_by_id')?>/"+id;
