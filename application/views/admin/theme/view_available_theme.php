...
<aside class="right-side">
    ...
    <section class="content">
        ...
        <?php echo form_open_multipart('newsadmin/Theme/upload_new_theme');?>
                        ...
                        <div class="caption">
                            ...
                            <p>
                                ...
                                if (@$theme->default_theme !== $value) {
                                    echo '<a href="' . base_url() . 'newsadmin/Theme/active_theme/' . $value . '" class="btn btn-primary" role="button">'.display('active').'</a>';
                                }
                                ?>
