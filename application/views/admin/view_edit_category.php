...
<aside class="right-side">
    ...
    <section class="content col-sm-4">
        ...
        echo form_open_multipart('newsadmin/Category/update_category/'.$this->uri->segment(4),$at);
        ?>
        <div class="form-group">
            ...
            <div class="form-group">
                <label>
                    <a href="<?php echo base_url(); ?>newsadmin/Category/list_of_categories" class="btn btn-default"><i class="glyphicon glyphicon-backward"></i> Go Back</a>
                </label>
