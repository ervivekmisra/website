    ...
    <section class="content">
        <div class="row">
            <?php 
                ...
                echo form_open('newsadmin/News_list/',$form_attribute);
            ?>
                ...
                ?>
                    <tr  id="tr_<?php echo $sl; ?>" onclick="change_color('<?php echo $sl; ?>', '#<?php echo $bgcolor; ?>');">
                        ...
                        <td align="center" class="smallfont">
                            ...
                            if ($row['status'] == 0) {
                                ?>
                                <a class="label label-warning" title="Publish" href="<?php echo base_url(); ?>newsadmin/News_edit/unpublishd/<?php echo $row['news_id']; ?>"><?php echo display('publish');?></a>

                                <?php
                            } else {
                                ?>
                                <a class="label label-success" title="Publishd" href="<?php echo base_url(); ?>newsadmin/News_edit/publishd/<?php echo $row['news_id']; ?>"><?php echo display('unpublish');?></a>
