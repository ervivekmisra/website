...
<aside class="right-side">
    <section class="content col-sm-11">
        ...
        <?php 
            ...
            echo form_open('newsadmin/Positioning/', $attributes);
        ?>
        ...
        <?php 
            ...
            echo form_open('newsadmin/Positioning/update_positioning', $attributes);
        ?>
         <div class="row">
            <?php
                    ...
                    if (isset($newses) && is_array($newses)) {
                        foreach ($newses as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>newsadmin/Positioning/delete_positionbyid/<?php echo $value->id; ?>" onclick="return confirm('Are you want to delete?');"><i class="glyphicon glyphicon-trash"></i></a></td>
                            </tr>
                            <?php
                        }
                    }
