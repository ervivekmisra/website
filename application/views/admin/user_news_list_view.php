    ...
    <section class="content">
        <div class="row">
            <?php 
                ...
                echo form_open('newsadmin/News_list/user_interface',$form_attribute);
            ?>
            ...
            <table class="table table-bordered">
                ...
                ?>
                    <tr  id="tr_<?php echo $sl; ?>" onclick="change_color('<?php echo $sl; ?>', '#<?php echo $bgcolor; ?>');">
                        ...
                        <th width="40"><a href="<?php echo base_url(); ?>newsadmin/News_edit/user_news_edit/<?php echo $row['news_id']; ?>"><i class="fa fa-edit fa-2x"></i></a></th>
