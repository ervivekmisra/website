...
?>
    ...
    <aside class="right-side">
        ...
        ?>
        <?php  echo form_open('newsadmin/Social_auth_setting/update', array('method' =>'post'));?>
                ...
                <table id="table" class="table table-bordered">
                    ...
                    <input type="hidden" name="id[]" value="<?php echo $value->id; ?>" class="form-control">
                        <tr>
                            ...
                            <td align="center"><a href="<?php echo base_url()?>newsadmin/Social_auth_setting/update_status/<?php echo $value->id?>/<?php echo $value->status?>" class="btn btn-success">
