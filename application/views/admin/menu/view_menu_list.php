                ...
                <table id="table" class="table table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center">
                             <a class="label label-warning" href="<?php echo base_url(); ?>newsadmin/Menu/Udate_status/<?php echo $value->menu_id . '/' . $value->status; ?>">
                             <?php echo ($value->status == 0) ? "Unpublish" : "Publish";?>
                             </a>
                            </td>

                            <td align="center">
                                <a class="btn btn-primary" href="<?php echo base_url();?>newsadmin/Menu/Setup_menu_content/<?php echo $value->menu_id?>" > Setup</a>
                            </td>
...
function edit_menu(id)
{
    ...
    $('.form-group').removeClass('has-error'); // clear error class
    $('.help-block').empty(); // clear error string
    var url = "<?php echo site_url('newsadmin/Menu/Edit_data')?>/"+id;
...
function save()
{
    ...
    var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('newsadmin/Menu/Save_menu')?>";
    } else {
        url = "<?php echo site_url('newsadmin/Menu/Menu_update')?>";
    }
...
function delete_menu(id)
{
    ...
    {
         var url = "<?php echo site_url('newsadmin/Menu/Delete_menu')?>/"+id;
        // ajax delete data to database
        $.ajax({
            url : url,
            type: "GET",
