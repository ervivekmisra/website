...
<aside class="right-side">
    <section class="content">
        ...
        echo form_open('newsadmin/Pulling/save',$attribute);
        ?>
            ...
            <table class="table table-bordered table-hover">
                ...
                ?>
                    <tr  id="tr_<?php echo $sl; ?>" onclick="change_color('<?php echo $sl; ?>', '#<?php echo $bgcolor; ?>');">
                        ...
                        <th width="50"><a onclick="delete_cnf('<?php echo base_url(); ?>newsadmin/Pulling/delete/<?php echo $row['id']; ?>');" href="#"><i class="fa fa-trash-o fa-2x"></i></a></th>
                        <th width="30"><a title="Note: Click On for Slider start, Off for slider stop." href="<?php echo base_url(); ?>newsadmin/Pulling/status_edit/<?php echo $row['id'] . '/' . $row['status']; ?>"><?php
