...
<?php 
    ...
    echo form_open('newsadmin/Category/save_category_positions',$at);
?>
                ...
                if (isset($all_categories) && is_array($all_categories)) {
                    foreach ($all_categories as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>newsadmin/Category/update_view/<?php echo $value->category_id; ?>"><i class="glyphicon glyphicon-edit" rel="tooltip" title="Edit Category" id="blah"></i></a>&nbsp;
                                <a href="<?php echo base_url(); ?>newsadmin/Category/delete/<?php echo $value->category_id; ?>" onclick="return confirm('Are you want to delelte?');"><i class="glyphicon glyphicon-trash" rel="tooltip" title="Delete Category" id="blah"></i></a>
                            </td>
                        </tr>            
                        <?php
                    }
                    ...
                    echo '<tr>
                            <td colspan="5">
                            <div class="alert alert-danger">No Category found. <a href="' . base_url() . 'newsadmin/Category/add_category">Add Category</a>
                             </div>
                            </td>
                    </tr>';
                }
...
<script type="text/javascript">
    function imgStatus(category_id){
        ...
        $.ajax({
                url: "<?php echo base_url(); ?>newsadmin/Category/save_category_img_status/" + category_id,
