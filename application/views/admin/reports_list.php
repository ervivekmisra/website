    ...
    <section class="content">
        <div class="row">
            <?php 
                ...
                echo form_open('newsadmin/Reports_controller',$form_attribute);
            ?>
                ...
                ?>
                    <tr  id="tr_<?php echo $sl; ?>" onclick="change_color('<?php echo $sl; ?>', '#<?php echo $bgcolor; ?>');">
                        ...
                        <td align="center" class="smallfont">
                            ...
                            if ($row['status'] == 0) {
                                ?>
                                <a class="label label-warning" title="Publishd" href="<?php echo base_url(); ?>newsadmin/News_edit/unpublishd/<?php echo $row['news_id']; ?>"><?php echo display('unpublish')?></a>

                                <?php
                            } else {
                                ?>
                                <a class="label label-success" title="Publishd" href="<?php echo base_url(); ?>newsadmin/News_edit/publishd/<?php echo $row['news_id']; ?>"><?php echo display('publish')?></a>

                                <?php
                            }
                            ?>
                        </td>
                        <th width="40"><a href="<?php echo base_url(); ?>newsadmin/News_edit/index/<?php echo $row['news_id']; ?>"><i class="fa fa-edit fa-2x"></i></a></th>
                        <th width="50"><a onclick="delete_cnf('<?php echo base_url(); ?>newsadmin/delete/singal/<?php echo $row['news_id']; ?>')" href="#"><i class="fa fa-trash-o fa-2x"></i></a></th>
                    </tr>
                    <?php
                    $sl++;
                }
