              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php foreach($subscription as $info){?>
                  <tr role="row" class="odd">
                    ...
                    <td>  
                        <a href="<?php echo base_url()?>newsadmin/Subscriber_manage/delete/<?php echo $info->subs_id;?>"><span class="label label-danger" ><i class="fa fa-trash-o"></i><span class="label label-danger" ></a>
                    </td>
                  </tr>
                  <?php }?>
                </tbody>
