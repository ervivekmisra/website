...
<aside class="right-side">
    <section class="content col-sm-11">    
        ...
        <a href="<?php echo base_url(); ?>newsadmin/Users/clearLog" class="pull-right btn btn-primary" onclick="return confirm('After clear log, you will be logout.')"><?php echo display('clear_log')?></a></div>
        <?php
