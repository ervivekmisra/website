...
<aside class="right-side">
    ...
    <?php
        ...
        echo form_open_multipart('newsadmin/News_post/post', $attributes);
    ?>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo anchor_popup('newsadmin/News_post/my_window/', 'Library', $nw_img_search); ?>
                            </td>
                        </tr>
                    </table>
                </fieldset>
        ...
        <div class="row-fluid">
            <fieldset>
                ...
                <table width="100%">
                    <tr>
                        <td colspan="2">
                            <?php echo display('keyword');?>: <input name="meta_keyword" id="tags" class="form-control" />
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" value="1" name="status_confirmed" id="status_confirmed" checked="checked" /><?php echo display('status');?> &nbsp;
                                    </td> 
                                </tr>
