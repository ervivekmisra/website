...
<aside class="right-side">
    <section class="content col-sm-12">
        <div class="col-sm-5">
            <div class="page_heading"><i class="glyphicon glyphicon-cog"></i>&nbsp; <?php echo display('fixed_keyword_settings')?> </div>
            <?php
                ...
                echo form_open('newsadmin/Seo/updat_fixed_keyword_code',$attributs);
            ?>
                <div class="form-group">
                    <label><?php echo display('fixed_keyword_comm_separated')?> </label>
