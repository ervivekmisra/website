...
div.desc {
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBo0l7EcNxwWoTYIgE3-p3J0m5_W844_Pg&libraries=places"></script>
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
                              ...
                              <!-- new start -->
                  <li><a href="<?php echo site_url('userlist'); ?>">Members</a></li>

                 <li><a target="_blank" href="<?php echo site_url('terms.php'); ?>">Terms & Policy</a></li> 
          ...
          <?php if($this->user->loggedin) : ?>
              <li><a href="<?php echo site_url("user_settings") ?>" data-target="#" aria-expanded="false" id="setting-menu-drop">
                      <span class="glyphicon glyphicon-cog notification-icon"></span> </a>

              <li><a href="#" data-target="#" onclick="load_friend_requests()" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="friend_requests_noti-menu-drop">
                      <span class="fa fa-group " style="font-size:23px"></span>
                      <?php if($this->user->info->noti_count_friend > 0) : ?>
                          <span class="badge notification-badge small-text">
                        <?php echo $this->user->info->noti_count_friend ?></span>
                      <?php endif; ?></a>
                  <ul class="dropdown-menu" aria-labelledby="friend_requests_noti-menu-drop">
                      <li>
                          <div class="notification-box-title">
                              Friend Requests <?php if($this->user->info->noti_count_friend > 0) : ?><span class="badge click" id="noti-click-unread" onclick="load_friend_requests()"><?php echo $this->user->info->noti_count_friend ?></span><?php endif; ?>
                          </div>
                          <div id="friend_requests-scroll">
                              <div id="loading_spinner_friend_requests">
                                  <span class="glyphicon glyphicon-refresh" id="ajspinner_friend_requests"></span>
                              </div>
                          </div>
                          <div class="notification-box-footer">
                              <a href="<?php echo site_url("user_settings/friend_requests") ?>"><?php echo lang("ctn_414") ?></a>
                          </div>
                      </li>
                  </ul>
              </li>
            <li>
                  <a href="#" data-target="#" onclick="load_notifications()" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="noti-menu-drop">
                    <span class="fa fa-globe" style="font-size:25px"></span>
            ...
            <li><a href="#" data-target="#" onclick="load_chats()" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="email-menu-drop"><span class="fa fa-comment"  style="font-size:25px"></span><span class="badge notification-badge small-text" id="chat-noti"></span></a>
            ...
            <li class="user_bit"><a class="profile_img" href="<?php echo site_url("profile/" . $this->user->info->username) ?>"><img src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $this->user->info->avatar ?>" class="user_avatar"> </a><a href="javascript:void(0)" class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><?php if($this->settings->info->user_display_type) : ?>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
              ...
              <li><a href="<?php echo site_url("profile/friends/" . $this->user->info->ID) ?>"><?php echo lang("ctn_493") ?></a></li>
                <li><a href="<?php echo site_url("profile/albums/" . $this->user->info->ID) ?>">My Photos</a></li>
    ...
    <div id="footer" class="clearfix">
      <span class="pull-left"><?php echo lang("ctn_170") ?> <a href="http://surfcloud.com.br">surfcloud</a> - <?php echo $this->settings->info->site_name ?> V<?php echo $this->settings->version ?> - <a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></span>
    </div>
