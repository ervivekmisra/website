...
<?php endif; ?>
    <head>
        ...
        <link href="<?php echo base_url();?>bootstrap/css/bootstrap-themef.min.css" rel="stylesheet" media="screen">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li><a href="<?php echo site_url("user_settings") ?>" data-target="#" aria-expanded="false" id="setting-menu-drop">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
              ...
              <li><a href="<?php echo site_url("profile/friends/" . $this->user->info->ID) ?>">My <?php echo lang("ctn_493") ?></a></li>
              <li><a href="<?php echo site_url("profile/albums/" . $this->user->info->ID) ?>">My <?php echo lang("ctn_483") ?></a></li>
