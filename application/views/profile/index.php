...
function load_posts(userid) 
{
 ...
 <div class="profile-header" style="background: url(<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative . "/" . $user->profile_header.'?v='.time() ?>) center center; background-size: cover;">
 <div class="profile-header-avatar">
	<img src="<?php echo base_url() ?>/<?php echo $this->settings->info->upload_path_relative ?>/<?php echo $user->avatar.'?v='.time() ?>">
 </div>
...
<?php echo $user->first_name ?> <?php echo $user->last_name ?> <?php if($user->verified) : ?><img src="<?php echo base_url() ?>images/verified_badge.png" width="14" data-placement="top" data-toggle="tooltip" title="<?php echo lang("ctn_695") ?>"><?php endif; ?>
 ...
 <ul>
  ...
  <li><a href="<?php echo site_url("profile/albums/" . $user->ID) ?>">Photos</a></li>
 </ul>
 ...
 <div class="col-md-4">
 	<div class="page-block">
        <div class="page-block-title">
          <span class="glyphicon glyphicon-picture"></span> <a href="<?php echo site_url("profile/albums/" . $user->ID) ?>">My Photos</a>
        </div>
                        ...
                        if( $count < 10) : ?>
                            <li class="album-image all_album_list">
                                <?php if(isset($r->file_name)) : ?>
                                    <img class="" src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $r->file_name ?>" width="50px" height="50px" alt="<?php echo $r->name . "<br>" . $r->description ?>">
                                <?php else : ?>.
                                    <img class="" src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/default_album.png" width="240" alt="<?php echo $r->name . "<br>" . $r->description ?>">
                                <?php endif; ?>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
