...
<?php else : ?> 
  ...
  <button type="button" class="btn btn-success btn-sm addFriend" onclick="add_friend(<?php echo $user->ID ?>)" id="friend_button_<?php echo $user->ID ?>"><?php echo lang("ctn_602") ?></button>
...
<script type="text/javascript">
  ...
  $('.addFriend').click(function() {
      ...
      setTimeout( function(){ 
          ...
          $('.addFriend').removeClass('disablebutton');
      },4000 );
  });
</script>