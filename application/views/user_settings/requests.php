...
<script type="text/javascript">
  ...
  $('.accept_btn').click(function() {
      ...
      setTimeout( function(){ 
          $('.accept_btn').removeAttr('disabled');
          $('.accept_btn').removeClass('disablebutton');
      },4000 );
  });
</script>