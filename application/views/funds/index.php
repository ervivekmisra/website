...
<p class="align-center"><img src="<?php echo base_url() ?>/images/paypal.png"></p>
		...
		<div class="input-group col-md-4">
		    ...
		    <option value="5.00"><?php echo $this->settings->info->payment_symbol ?>5.00 - 5 <?php echo lang("ctn_350") ?></option>
		    <option value="10.00"><?php echo $this->settings->info->payment_symbol ?>10.00 - 10 <?php echo lang("ctn_350") ?></option>
		    <option value="30.00"><?php echo $this->settings->info->payment_symbol ?>30.00 - 30 <?php echo lang("ctn_350") ?></option>
...
<form action="<?php echo site_url("IPN/stripe/1") ?>" method="POST">
  <script
    ...
    data-amount="500"
    data-label="Buy <?php echo $this->settings->info->payment_symbol ?>5.00 - 5 <?php echo lang("ctn_350") ?>"
    data-name="<?php echo $this->settings->info->payment_symbol ?>5.00 for <?php echo $this->settings->info->site_name ?>"
    data-description="<?php echo lang("ctn_350") ?>"
...
<form action="<?php echo site_url("IPN/stripe/2") ?>" method="POST">
  <script
    ...
    data-key="<?php echo $stripe['publishable_key']; ?>"
    data-amount="1000"
    data-label="Buy <?php echo $this->settings->info->payment_symbol ?>10.00 - 10 <?php echo lang("ctn_350") ?>"
...
<form action="<?php echo site_url("IPN/stripe/3") ?>" method="POST">
  <script
    ...
    data-key="<?php echo $stripe['publishable_key']; ?>"
    data-amount="3000"
    data-label="Buy <?php echo $this->settings->info->payment_symbol ?>30.00 - 30 <?php echo lang("ctn_350") ?>"
...
<div class="row">
    ...
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_249") ?> <?php echo $this->settings->info->payment_symbol ?>5.00 - 5 <?php echo lang("ctn_350") ?>' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_249") ?> <?php echo $this->settings->info->payment_symbol ?>10.00 - 10 <?php echo lang("ctn_350") ?>' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_249") ?> <?php echo $this->settings->info->payment_symbol ?>30.00 - 30 <?php echo lang("ctn_350") ?>' />
                </form>
    </div>
</div>
<?php endif; ?>
