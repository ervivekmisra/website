...
function load_friend_requests()
{
    ...
    $.ajax({
        url: global_base_url + "home/load_friend_request",
        beforeSend: function () {
            $('#loading_spinner_friend_requests').fadeIn(10);
            $("#ajspinner_friend_requests").addClass("spin");
        },
        complete: function () {
            $('#loading_spinner_friend_requests').fadeOut(10);
            $("#ajspinner_friend_requests").removeClass("spin");
        },
        data: {
        },
        success: function(msg) {
            $('#friend_requests-scroll').html(msg);
        }
